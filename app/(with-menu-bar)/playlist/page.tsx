...
export default function Page() {
  ...
  return (
    <>
      <Card className='w-full h-[600px] min-w-[800px] dark:shadow-none border-2'>
        <CardBody className='flex flex-row p-0'>
          <div className='h-full border-r-2 flex flex-col'>
            <div className='py-2 border-b-2 w-[200px] flex justify-between items-center px-4'>
          ...
          <div className='py-2 px-4 overflow-y-auto scrollbar w-full'>
            {mediaList.length > 0 ? (
              <MediaCardGrid
                grid='grid-cols-4'
                mediaList={mediaList}
