...
import { Button, Input, Link, Image, Divider, Spinner } from "@nextui-org/react";
...
const CommonForm = (
	...
	const [isQuick, setIsQucik] = useState(false)
	...
	const methodMemo = useMemo(() => {
		return signMethod === SignInType.EMAIL ? SignInType.PASSWORD : SignInType.EMAIL
	}, [signMethod])
		...
		<div className="w-full mt-4 flex flex-col items-center">
			...
			<div className="w-full mt-2 px-2">
				<Button variant="light" isIconOnly>
					<WeChatIcon onClick={() => { setIsWeChat(!isWeChat) }} />
				</Button>
			</div>
		</div>
	)
