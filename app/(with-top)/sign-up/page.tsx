			...
			/>
			{
				isFinished ?
					<div className="flex flex-col justify-center min-h-[600px]">
						<h1 className="text-3xl ">Thanks for Signing up, please check your email!</h1>
					</div>
					:
							...
							<div className="w-full mt-4">
								{
									formMap.map((item, index) =>
										...
										<Input
											...
											errorMessage={errors[item.name as SignUpKeyParams] && item.error}
								...
								<div className="flex">
									<Input
										...
										errorMessage={errors.code && formMap[formMap.length - 1].error}
