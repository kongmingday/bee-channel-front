...
export const Logo: React.FC<IconSvgProps> = ({
  ...
  <>
    <p
      className={clsx(
        "w-36 font-bold text-lg align-middle text-inherit",
        props.className
      )}
    >
      bee-channel
  ...
  return (
    ...
    >
      <path
        ...
        d="M78,24H71.8828C71.2559,12.82,67.2773,0,42,0a5.9966,5.9966,0,0,0-6,6c0,10.8809-.1128,20.3687-8.6917,30H6a5.9966,5.9966,0,0,0-6,6V90a5.9966,5.9966,0,0,0,6,6H78A18.02,18.02,0,0,0,96,78V42A18.02,18.02,0,0,0,78,24ZM12,48H24V84H12ZM84,78a6.0078,6.0078,0,0,1-6,6H36V44.4023c9.9258-10.8867,11.6426-21.9257,11.9355-32.121C60,13.5938,60,19.5117,60,30a5.9966,5.9966,0,0,0,6,6H78a6.0078,6.0078,0,0,1,6,6Z"
      />
    </svg>
  );
};
  ...
  return (
    ...
    >
      <g data-name="45-Smile" id="_45-Smile">
        ...
        <path
          fill="currentColor"
          d="M15,13H13a2,2,0,0,0-4,0H7a4,4,0,0,1,8,0Z"
        />
        <path
          fill="currentColor"
          d="M25,13H23a2,2,0,0,0-4,0H17a4,4,0,0,1,8,0Z"
        />
        <path
          fill="currentColor"
          d="M15,23H13a7,7,0,0,1,7-7v2A5,5,0,0,0,15,23Z"
        />
      </g>
    </svg>
  );
...
export const MoneyIcon: React.FC<IconSvgProps> = ({
  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M227.076,220.157c0-11.572,16.925-13.548,31.606-13.548c13.837,0,32.744,6.485,48.553,14.681l3.098-31.895  c-7.906-4.52-26.247-9.884-44.877-11.005l4.515-32.461H239.77l4.521,32.461c-38.947,3.664-51.651,26.242-51.651,45.154  c0,47.697,88.898,37.547,88.898,66.888c0,11.017-10.434,14.959-28.785,14.959c-24.832,0-43.467-8.74-53.056-17.779l-4.803,35.848  c9.04,5.364,27.375,10.161,49.397,11.294l-4.521,31.329h30.201l-4.515-31.617c45.722-3.954,53.906-28.23,53.906-44.311  C319.363,233.428,227.076,247.532,227.076,220.157z"
      />
    </svg>
  );
};
...
export const LaterIcon: React.FC<IconSvgProps> = ({
  ...
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M12,2A10,10,0,1,0,22,12,10,10,0,0,0,12,2Zm0,18a8,8,0,1,1,8-8A8,8,0,0,1,12,20ZM13,6H11v7h6V11H13Z"
      />
    </svg>
  );
};
...
export const SignOutIcon: React.FC<IconSvgProps> = ({
  ...
  return (
    ...
    >
      <path
        fill={fill || "currentColor"}
        d="M15,30H2V2h13c0.552,0,1-0.448,1-1s-0.448-1-1-1H1C0.448,0,0,0.448,0,1v30c0,0.552,0.448,1,1,1h14   c0.552,0,1-0.448,1-1S15.552,30,15,30z"
      />
      <path
        fill={fill || "currentColor"}
        d="M31.71,15.302l-6.9-6.999c-0.391-0.395-1.024-0.394-1.414,0c-0.391,0.394-0.391,1.034,0,1.428l5.2,5.275   H8.003c-0.552,0-1,0.452-1,1.01c0,0.558,0.448,1.01,1,1.01h20.593l-5.2,5.275c-0.391,0.395-0.391,1.034,0,1.428   c0.391,0.395,1.024,0.395,1.414,0l6.899-6.999C32.095,16.341,32.099,15.69,31.71,15.302z"
      />
    </svg>
  );
};
...
export const PictureIcon: React.FC<IconSvgProps> = ({
  ...
  return (
    ...
    >
      <path
        fill={fill || "currentColor"}
        d="M5.4,5.6v58.8h69.1V5.6H5.4z M71.6,61.4H8.4V8.6h63.1V61.4z"
      />
      <polygon
        fill={fill || "currentColor"}
        points="28.3,27.7 39,38.4 41.2,36.3 28.3,23.4 15.4,36.3 17.6,38.4   "
      />
      <polygon
        fill={fill || "currentColor"}
        points="41.8,27.7 62.3,48.2 64.4,46.1 41.8,23.4 35.3,29.9 37.4,32   "
      />
      <path
        fill={fill || "currentColor"}
        d="M59.4,23.1c3,0,5.4-2.4,5.4-5.4s-2.4-5.4-5.4-5.4S54,14.8,54,17.7S56.5,23.1,59.4,23.1L59.4,23.1z M59.4,15.4    c1.3,0,2.4,1.1,2.4,2.4c0,1.3-1.1,2.4-2.4,2.4c-1.3,0-2.4-1.1-2.4-2.4C57,16.4,58.1,15.4,59.4,15.4C59.4,15.3,59.4,15.3,59.4,15.4    L59.4,15.4z"
      />
    </svg>
  );
};
...
export const RemoveIcon: React.FC<IconSvgProps> = ({
  size = 20,
  width,
  height,
  fill,
...
export const AddCollectionIcon: React.FC<IconSvgProps> = ({
  size = 20,
  width,
  height,
  fill,
