...
export const WeChatLogin = (
  ...
  useEffect(() => {
    ...
    var codeRquest = `https://open.weixin.qq.com/connect/qrconnect?` + qs.stringify(weChatParam)
    ...
    codeIframe.src = codeRquest
    container_ref.current?.appendChild(codeIframe)

  }, [])
  return (
    <div className={clsx('border-2 rounded-xl overflow-hidden mb-4 flex items-center pt-6 h-[300px]', props.className)}>
      <div className={clsx('', props.className)} ref={container_ref} />
    </div>
  )
}
