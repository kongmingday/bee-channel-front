      ...
      {qrcCode && qrcCode.length > 0 ? (
        <>
          ...
          <div className="w-full flex flex-col items-center">
            ...
            <Image alt="pay qcr code" src={qrcCode} />
          </div>
        </>
      ) : (
        <>
          ...
          <Button onPress={handleSuperChatCommit} color="primary" fullWidth>
            Commit
          </Button>
        </>
      )}
...
const LiveChatInputBase = (props: {
  ...
  return (
    <div className="flex flex-1 items-center gap-4 w-full">
      ...
      />
      <EmojiPicker inputRef={inputRef} setComment={setMessage} />
    </div>
  );
};
...
const LiveChatInput = () => {
  return (
    <div className="flex gap-4 w-full items-center">
      ...
      <Popover placement="top-end" size="lg" showArrow={true}>
        <PopoverTrigger>
  ...
  return (
    <>
      <Chip
        ...
        avatar={<Avatar name="test flex-none" />}
      >
        100
      </Chip>
      {isOpen && (
        <Card className="w-[400px] absolute top-28">
          ...
          <CardBody>
            <div className="flex w-full gap-2">
              ...
              <div className="flex flex-col w-full">
                <p onClick={() => {}} className="text-default-500 w-[330px]">
